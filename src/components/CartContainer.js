...
import Banana from "../images/f9.png";
      ...
      {/* bottom section */}
        <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
          ...
          <div className="w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
            ...
            <img src={Banana} className="w-20 h-20 max-w-[60px] rounded-full object-contain" alt=""/>
            {/* name section */}
            <div className="flex flex-col gap-2">
                <p className="text-base text-gray-50">Banana</p>
                <p className="text-sm block text-gray-300 font-semibold">455</p>
            </div>
            {/* button section */}
